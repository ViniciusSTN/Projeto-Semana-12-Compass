export const HomeFirstSection = () => {
  return (
    <section className="bg-home-fsection h-716px bg-no-repeat bg-center flex justify-center bg-lightgray2">
      <div className="container flex items-center justify-end">
        <div className="max-w-643px bg-off-white rounded-lg p-10 sm:mr-14">
